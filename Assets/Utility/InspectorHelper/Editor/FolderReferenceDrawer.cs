    ...
    public class FolderReferencePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (GUI.Button(objectFieldRect, "", GUI.skin.GetStyle("IN ObjectField")))
            {
                ...
                //OpenFolderPanel may lead to StackEmpty error. GUIUtility.ExitGUI() can solve this issue,but need to ApplyModifiedProperties first ,or data will not be saved.
